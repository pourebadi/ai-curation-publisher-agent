...
export default function RestoredDashboardApp(): JSX.Element {
  ...
  useEffect(() => { if (internalReady) { void loadAdminConfig(); void loadRouteManager(); void loadRecentTelegramOutputs(); void loadTelegramQueue(); void loadMediaJobs(); } }, [internalReady, settings.apiBaseUrl]);
